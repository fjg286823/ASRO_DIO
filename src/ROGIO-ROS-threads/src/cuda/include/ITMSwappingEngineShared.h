...
__device__ inline void combineVoxelDepthInformation(const ITMVoxel_d &src, ITMVoxel_d &dst, int maxW) {
...
__device__ inline void combineVoxelColorInformation(const ITMVoxel_d &src, ITMVoxel_d &dst, int maxW) {
...
// struct CombineVoxelInformationDepth {
//     __device__ static void compute(const ITMVoxel_d &src, ITMVoxel_d &dst, int maxW) {
